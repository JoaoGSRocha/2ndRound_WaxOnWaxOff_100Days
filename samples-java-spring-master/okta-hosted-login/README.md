...
mvn -Dokta.oauth2.issuer=https://dev-66656914.okta.com/oauth2/default \
    -Dokta.oauth2.clientId=0oa2yistknBdsPhwp5d7 \
    -Dokta.oauth2.clientSecret=cAaYLYVkJmbLY8isCG2xvacuZ6XpydwAVDhiWZEp \
...
```bash
export OKTA_OAUTH2_ISSUER=https://dev-66656914.okta.com/oauth2/default
export OKTA_OAUTH2_CLIENT_ID=0oa2yistknBdsPhwp5d7
export OKTA_OAUTH2_CLIENT_SECRET=cAaYLYVkJmbLY8isCG2xvacuZ6XpydwAVDhiWZEp
